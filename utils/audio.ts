// This file contains audio decoding utilities based on the Gemini API guidelines.
 ...
 * @param data The raw audio data as a Uint8Array (expected to be 16-bit PCM).
...
export async function decodeAudioData(
  ...
  // The raw PCM data is 16-bit, so we need to convert the Uint8Array's buffer to an Int16Array.
